...
const skills=[
    ...
    //Tools
    {name:"Git/GItHub", level:15,category:"tools"},
        ...
        <div className="conatiner mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredSkills.map((skill,key) => (
                    <div key={key}
                     className="bg-card p-6 ronded-lg shadow-xs card-hover">
                        <div className="text-left mb-4">
                            <h3 className="font-semibold text-lg ">{skill.name}</h3>
                     </div>
                     <div className="w-full bg-secondary/50 h-2n rounded-full overflow-hidden">
